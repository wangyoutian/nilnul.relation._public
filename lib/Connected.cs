...
namespace nilnul.relation
{
	...
	{
		static public bool Eval<T,TEq>(Relation<T,TEq> relation)
			where TEq:IEqualityComparer<T>,new()
		{

			return PartitionOfVortex(relation).Count < 2;

			

		}

		static public void Assert<T>(Relation2<T> relation) { 
		...
		static public nilnul.collection.set.s.Set<T, TEq> PartitionOfVortex<T, TEq>(Relation<T, TEq> relation)
		where TEq : IEqualityComparer<T>, new()
		{
